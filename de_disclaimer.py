...
def main():
    ...
    st.write("Die Informationen auf dieser Seite sind keine Konsumempfehlung. Sie wurden sorgfältig zusammengestellt, können aber nur einen ersten Anhaltspunkt fu‌r eigene Nachforschungen bilden. Konsumerfahrungen und Risiken sind individuell. Sie können von den genannten Informationen abweichen. Sich verstärkende Kombinationen und Mischkonsum generell haben ein höheres Risiko fu‌r unerwu‌nschte Nebenwirkungen als der Monokonsum von Substanzen. Eine Verringerung der wahrgenommenen Effekte bei der Kombination von Substanzen ist meistens durch eine Überlagerung und nicht durch eine gegenseitige Aufhebung zu erklären. Die unter gefährlich genannten Kombinationen sind keine abschließende Liste gesundheitsschädlicher Kombinationen.")
